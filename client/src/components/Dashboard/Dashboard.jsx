            ...
            <Menu as="div" className="relative">
              ...
              <Menu.Items className="absolute right-0 mt-2 w-48 bg-dark/90 backdrop-blur-lg rounded-lg shadow-xl border border-primary/20">
                <div className="p-2 space-y-2">
                  <Menu.Item>
                    {({ active }) => (
                      <button className={`w-full text-left px-4 py-2 rounded-md ${active ? 'bg-primary/20' : ''}`}>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <PlanCard
                  ...
                  onClick={() => console.log('Generate Workout Plan')}
                />
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="bg-dark/80 backdrop-blur-lg p-4 rounded-xl border border-primary/20">
              ...
              <div className="mt-4 space-y-4">
                <BMICategory label="Underweight" range="< 18.5" isCurrent={userDetails.bmi < 18.5} />
                <BMICategory label="Normal" range="18.5 - 24.9" isCurrent={userDetails.bmi >= 18.5 && userDetails.bmi <= 24.9} />
                <BMICategory label="Overweight" range="25 - 29.9" isCurrent={userDetails.bmi >= 25 && userDetails.bmi <= 29.9} />
                <BMICategory label="Obese" range="≥ 30" isCurrent={userDetails.bmi >= 30} />
              </div>
            </div>
          </motion.div>
        </div>
...
const BMICategory = ({ label, range, isCurrent }) => (
  <div className={`flex justify-between items-center p-3 rounded-lg ${isCurrent ? 'bg-primary/20 border border-primary/30' : 'bg-dark/60'}`}>
    <div>
