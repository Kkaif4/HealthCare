...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // along with the rest of the form data, possibly using FormData API
  };
    ...
    <div className="min-h-screen bg-dark flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-light/80 mt-2">Create your free health tracking account</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-6 md:col-span-2">
              ...
              <div>
                <label htmlFor="fullName" className="block text-light/80 mb-2">Full Name</label>
                <input
                  id="fullName"
                  name="fullName"
                  type="text"
            ...
            <div className="space-y-6 md:col-span-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="age" className="block text-light/80 mb-2">Age</label>
                  <input
                    id="age"
                    name="age"
                    type="number"
                ...
                <div>
                  <label htmlFor="gender" className="block text-light/80 mb-2">Gender</label>
                  <select
                    id="gender"
                    name="gender"
                ...
                <div>
                  <label htmlFor="weight" className="block text-light/80 mb-2">Weight</label>
                  <div className="flex">
                    <input
                      id="weight"
                      name="weight"
                ...
                <div>
                  <label htmlFor="height" className="block text-light/80 mb-2">Height</label>
                  <div className="flex">
                    <input
                      id="height"
                      name="height"
              ...
              <div>
                <label htmlFor="medicalHistory" className="block text-light/80 mb-2">
                  Medical History
                ...
                ></textarea>
                <p className="text-light/60 text-sm mt-1">
                  This information will be kept private and helps us personalize your health recommendations
                </p>
              </div>
            </div>
          </div>
