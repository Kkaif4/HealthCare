...
import { HeartIcon, ClockIcon, ChartBarIcon, BeakerIcon } from '@heroicons/react/24/outline';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-light/80">
            Bridging the gap between modern life and sustainable health through AI-powered personalization
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <h3 className="text-2xl font-semibold text-light mb-4">Modern Lifestyle Challenges</h3>
            <p className="text-light/80">
              Time scarcity, information overload, and mental health demands require smart solutions
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-2xl font-semibold text-light mb-4">Prevention Focus</h3>
            <p className="text-light/80">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <h4 className="text-xl font-semibold text-light mb-2">Adaptive AI</h4>
            <p className="text-light/80">Real-time adjustments based on your progress</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-xl font-semibold text-light mb-2">Science-Backed</h4>
            <p className="text-light/80">Built with nutritionists and fitness experts</p>
          </motion.div>
        </div>
