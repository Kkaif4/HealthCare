      ...
      <div className="max-w-4xl mx-auto px-4 py-8 font-sans">
        ...
        <section className="mb-10">
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-gray-600 leading-relaxed">
              Our AI platform delivers <span className="text-blue-600 font-medium">personalized fitness plans</span> that 
              adapt to your unique needs, goals, and lifestyle preferences.
            </p>
          </div>
        </section>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="bg-red-50 rounded-lg p-6">
            <h2 className="text-xl font-semibold mb-4 text-red-700">The Challenge</h2>
          ...
          <div className="bg-green-50 rounded-lg p-6">
            <h2 className="text-xl font-semibold mb-4 text-green-700">Our Solution</h2>
            <ul className="space-y-3">
              {[
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: '📈', title: 'Smart Planning', description: 'AI-driven recommendations that adapt to your progress' },
              { icon: '🍎', title: 'Nutrition AI', description: 'Personalized meal plans based on your preferences' },
              { icon: '🏋️', title: 'Workout AI', description: 'Optimized exercise routines for any equipment' }
            ].map((feature, index) => (
        ...
        <section className="mb-10 text-center">
          <div className="bg-gradient-to-r from-blue-500 to-green-500 text-white py-8 px-6 rounded-lg">
            ...
            <p className="mb-6">Join thousands achieving their health goals with AI assistance</p>
